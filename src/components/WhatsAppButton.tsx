...
import { phone } from '../data/doctor'
import { EASE } from '../lib/motion'

/**
 * Botón flotante de WhatsApp (lado izquierdo). Anillo pulsante + rebote suave,
...
export function WhatsAppButton() {
  ...
  return (
    <motion.div
      className="fixed bottom-5 left-4 z-40 md:bottom-7 md:left-6"
